...
这个方法是真真的调用getObject的方法获得FactoryBean生产的对象。从代码中可以看到，具体产生Bean的地方时这个getObject方法，Spring为这个FactoryBean提供了70多个实现，比如Poxy、JDNI、RMI等等。所以我们不再举例，看个截图，下面我们将自己动手实现一个FactoryBean。

![c0ae904a86d78455fc6c61d80ef9ca25.jpeg](evernotecid://D26B31D5-DFDC-482E-B0DE-E53F5928D178/appyinxiangcom/17104432/ENNote/p921?hash=c0ae904a86d78455fc6c61d80ef9ca25)
