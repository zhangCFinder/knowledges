...
5. registerDisposableBeanIfNecessary(beanName, bean, mbd);注册disposable bean
# 四、spring中bean的生命周期

![57f4675a030521eb5f4c082e19a0d78a](3.Spring系列之bean的生命周期-总论.resources/E5214141-9461-4F7C-9080-8B3A659DD0D4.png)
...
4. 初始化Bean
    1. 激活Aware方法
    2. 处理器的应用(BeanPostProcessor接口)
    3. 激活自定义的init方法
  
5. 使用Bean。 驻留在应用的上下文中，直到该应用上下文被销毁。

6. 销毁(destory-mthod & 实现DisposableBean接口)
